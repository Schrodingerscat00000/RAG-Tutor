...
# ---------- CONFIG ----------
PARSED_INPUT_FILE = Path("IvriTutor_Demo/parsed_outputs/8th_grade_lesson_2_parsed.json")
EMBEDDINGS_OUTPUT_FILE = Path("IvriTutor_Demo/parsed_outputs/8th_grade_lesson_2_embeddings.json")
